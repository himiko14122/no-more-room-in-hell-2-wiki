    ...
    <header className="sticky top-0 z-50 border-b border-[var(--color-border)] bg-[var(--color-bg-primary)]/90 backdrop-blur-xl">
      <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto xl:max-w-none xl:ml-40 xl:mr-0">
        <div className="flex items-center justify-between h-16">
          <Link href="/" title={SITE_NAME.replace(/ Wiki$/, '')} className="flex items-center gap-2 text-lg font-bold font-[var(--font-heading)] whitespace-nowrap">
...
<Link
                        ...
                        <div className="border-t border-[var(--color-border)]">
                          <Link
                            href={item.path}
                            title={t(`category_articles_${item.key}`)}
